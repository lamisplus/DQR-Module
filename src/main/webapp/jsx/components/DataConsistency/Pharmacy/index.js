...
const useStyles = makeStyles((theme) => ({
    ...
    const [pharmacyPatientsView, setPharmacyPatientsView] = useState([])
    ...
    axios
          .get(`${baseUrl}dqr/patient-pharmacy?indicator=${patientDemo}`, {
            headers: { Authorization: `Bearer ${token}` },
          })
          .then((response) => {
            setPharmacyPatientsView(response.data);
                    ...
                    {showPatientDetail &&(<>
                      <Button
                        ...
                        <MaterialTable
                            ...
                            data={ pharmacyPatientsView.map((row) => ({
                              //Id: manager.id,
