...
public interface ClientVerificationRepository extends JpaRepository<DQA, Long> {
    ...
    @Query(value = "WITH clientVerification AS (\n" +
            "SELECT  e.unique_id AS patientId ,p.hospital_number AS hospitalNumber, INITCAP(p.sex) AS sex,\n" +
            "p.date_of_birth AS dateOfBirth, b.person_uuid AS person_uuid1, b.enrollment_date, b.biometric_valid_captured AS validcapture,recap.person_uuid AS personUuid,recap.enrollment_date,\n" +
