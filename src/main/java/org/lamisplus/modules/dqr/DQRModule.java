package org.lamisplus.modules.dqr;
...
@Slf4j
@EnableSwagger2
public class DQRModule extends AcrossModule
{
    public final static String NAME = "DQRModule";

    public static void main(String[] args) {
        SpringApplication.run (DQRModule.class, args);
    }
