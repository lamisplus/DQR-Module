package org.lamisplus.modules.dqa;
...
@Slf4j
@EnableSwagger2
public class DQAModule extends AcrossModule
{
    public final static String NAME = "DQAModule";

    public static void main(String[] args) {
        SpringApplication.run (DQAModule.class, args);
    }
